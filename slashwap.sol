...
contract SlashWap is Context, IERC20, Ownable {
    ...
    constructor() {
        _decimals = 9;
        _tTotal = 20000000000 * 10 ** uint256(_decimals);
        ...
        _taxFee = 4;
        _burnFee = 4;
        _maxTxAmount = 200000000 * 10 ** uint256(_decimals);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(sender != owner() && recipient != owner())
            require(amount <= _maxTxAmount, "Transfer amount exceeds 1% of Total Supply.");
